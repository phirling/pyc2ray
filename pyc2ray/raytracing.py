...
__all__ = ['do_all_sources','do_all_sources_octa','do_all_sources_unified']
...
def do_all_sources_octa(dr,srcflux,srcpos,r_RT,ndens,xh_av,sig,
    ...
    if cuda_is_init():
        ...
        libasora.do_all_sources(srcpos,srcflux,r_RT,cdh_flat,sig,dr,ndens_flat,xh_av_flat,phi_ion_flat,NumSrc,N,minlogtau,dlogtau,NumTau)
...
# reionization simulation, please use the evolve3D subroutine, which
